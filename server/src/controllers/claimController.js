            ...
            await pool.query(
                ...
                SELECT
                    ...
                    CASE
                        ...
                        THEN u.email
                        ELSE NULL
                    END AS claimant_email,

                    u.profile_image_url
                        AS claimant_profile_image
    ...
    try {
        ...
        if (
            ...
            return res.status(400).json({
                success: false,
                message:
                    "This item already has an accepted claim",
            });
        }
            ...
            if (
                ...
                return res
                    ...
                    .json({
                        success: false,
                        message:
                            "You are not authorized to cancel this claim",
                    });
            }
